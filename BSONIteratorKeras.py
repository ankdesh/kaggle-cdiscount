...
get_ipython().magic(u'time train_offsets_df = read_bson(train_bson_path, num_records=num_train_products, with_categories=True)')
...
get_ipython().magic(u'time bx, by = next(train_gen)')
...
get_ipython().magic(u'time bx, by = next(val_gen)')
